<script>
    ...
    let fecha = $state("")
    let estadosanimales = $state({})
    let observaciones = $state({})
    let tipotactoanimales = $state({})
...
<dialog id="tactoMasivo" class="modal modal-top mt-10 ml-5 lg:items-start rounded-xl lg:modal-middle">
    <div 
        class="
            ...
            <table class="table table-lg w-full " >
                <thead>
                    <tr>
                        ...
                        <th class="text-base p-0">Estado anterior</th>
                ...
                <tbody>
                    {#each selectanimales as a,i}
                        <tr>
                            ...
                            <td class="text-base p-0">{getEstadoName(a.prenada)}</td>
                            <td>
                                <label class="input-group ">
                                    <select 
                                        class={`
